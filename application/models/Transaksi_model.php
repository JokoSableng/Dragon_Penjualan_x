...
class Transaksi_model extends CI_Model
{
    ...
    function remove_checked_pembayaran_bbm($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
    ...
    function remove_checked_pembayaran_bkm($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_pemesanan_mutasi($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_pemesanan($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_export($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_lain($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_lokal($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_pkp($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_pms($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_mobil($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
    ...
    function remove_checked_penjualan_um($table, $tabled)
    {
        $delete = $this->input->post('check');
        for ($i = 0; $i < count($delete); $i++) {
            $this->db->where('row_id', $delete[$i]);
