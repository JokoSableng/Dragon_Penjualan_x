...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Retur Penerimaan Barang
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_Retur_Penerimaan_Barang/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="250px">No Lpb</th>
                        <th width="370px">No Sj</th>
                        <th width="250px">Tanggal</th>
                        <th width="50px">Kdmts</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Retur_Penerimaan_Barang/get_ajax_beli') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
