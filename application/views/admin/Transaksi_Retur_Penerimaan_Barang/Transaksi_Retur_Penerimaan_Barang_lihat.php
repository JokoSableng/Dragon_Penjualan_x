...
<div class="container-fluid">
	...
	<form id="transaksireturpenerimaanbarang" name="transaksireturpenerimaanbarang" action="<?php echo base_url('admin/Transaksi_Retur_Penerimaan_Barang/lihat_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
