...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-container" role="alert">
		<i class="fas fa-university"></i> Update Cek BKM PMS A
	</div>
	<form id="cekbkm_pmsa" name="cekbkm_pmsa" action="<?php echo base_url('admin/Transaksi_CekBKM_PMSA/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="input-group col-md-2">
							...
							<input class="form-control text_input NO_BUKTI" id="NO_BUKTI" name="NO_BUKTI" type="text" value="<?php echo $rowh->NO_BUKTI ?>" require>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input ACC" id="ACC" name="ACC" type="text" value="<?php echo $rowh->ACC ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($cekbkm_pmsa as $row) :
							?>
								<tr>
									<td><input name="REC[]" id="REC<?php echo $no; ?>" value="<?= $row->REC ?>" type="text" class="form-control REC text_input" onkeypress="return tabE(this,event)" readonly> <input name="NOBUKTI[]" id="NOBUKTI0" type="text" class="form-control NOBUKTI text_input" hidden readonly></td>
									<!-- <td>
									...
									<td><input name="TGL_FKTR[]" id="TGL_FKTR<?php echo $no; ?>" type="text" class="form-control text_input" value="<?php echo date('d-m-Y', strtotime($row->TGL_FKTR, TRUE)); ?>" readonly></td>
									<td><input name="TGL_SURAT[]" id="TGL_SURAT<?php echo $no; ?>" type="text" class="form-control text_input" value="<?php echo date('d-m-Y', strtotime($row->TGL_SURAT, TRUE)); ?>" readonly></td>
									...
									<td><input name="TANDA[]" maxlength="1" id="TANDA<?php echo $no; ?>" value="<?= $row->TANDA ?>" type="text" class="form-control TANDA text_input"></td>
									<td>
...
<script>
	...
	function tambah() {
        ...
        td4.innerHTML = "<input name='TGL_FKTR[]' id=TGL_FKTR" + idrow + " type='text' class='form-control TGL_FKTR text_input' readonly>";
        td5.innerHTML = "<input name='TGL_SURAT[]' id=TGL_SURAT" + idrow + " type='text' class='form-control TGL_SURAT text_input' readonly>";
