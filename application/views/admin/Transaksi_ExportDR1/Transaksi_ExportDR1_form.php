...
<div class="container-fluid">
	...
	<form id="exportdr1" name="exportdr1" action="<?php echo base_url('admin/Transaksi_ExportDR1/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_ExportDR1/filter_no_surat'); ?>',
				data: {
					no_surat: no_surat
				},
				dataType: 'json',
