...
<div class="container-fluid">
	...
	<form id="exportdr1" name="exportdr1" action="<?php echo base_url('admin/Transaksi_ExportDR1/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
