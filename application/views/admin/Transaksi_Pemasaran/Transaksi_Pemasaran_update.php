...
<div class="container-fluid">
	...
	<form id="pemasaran" name="pemasaran" action="<?php echo base_url('admin/Transaksi_PenjualanPMS/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
