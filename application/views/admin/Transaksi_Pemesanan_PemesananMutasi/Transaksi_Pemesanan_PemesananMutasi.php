...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Pemesanan Mutasi
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_Pemesanan_PemesananMutasi/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="230px">No Bukti</th>
                        <th width="250px">Tgl</th>
                        <th width="230px">No DO</th>
                        <th width="230px">Tgl DO</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Pemesanan_PemesananMutasi/get_ajax_so') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
