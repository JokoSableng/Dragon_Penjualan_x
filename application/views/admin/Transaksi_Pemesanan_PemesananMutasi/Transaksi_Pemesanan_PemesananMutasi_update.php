<?php
	foreach ($pemesanan_pemesananmutasi as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="pemesananpemesananmutasi" name="pemesananpemesananmutasi" action="<?php echo base_url('admin/Transaksi_Pemesanan_PemesananMutasi/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <?php
							$no = 0;
							foreach ($pemesanan_pemesananmutasi as $row) : 
						?>
							<tr>
...
<script>
	...
	// 		window.location.replace("<?php echo base_url('admin/Transaksi_Pemesanan_PemesananMutasi/upload_no_do/'.$rowh->ID)?>");
	// 	} else {
	// 		console.log('Test');
	// 	}
	// }
