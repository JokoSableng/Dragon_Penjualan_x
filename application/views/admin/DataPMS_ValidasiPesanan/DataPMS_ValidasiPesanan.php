...
<section>
    <div class="container-fluid">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Data PMS Validasi Pesanan
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <br>
        <form method="post" id="entri" action="<?php echo base_url('admin/DataPMS_ValidasiPesanan/index_DataPMS_ValidasiPesanan') ?>">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
        ...
        <form method="post" action="<?php echo base_url('admin/DataPMS_ValidasiPesanan/update') ?>">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#example').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": "<?php echo site_url('admin/DataPMS_ValidasiPesanan/get_ajaxBkt') ?>",
				"type": "POST"
			},
			"columnDefs": [{
					"targets": [0, 1],
        ...
        $('body').on('focusout keyup', 'input[type=search]', function() {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url('admin/DataPMS_ValidasiPesanan/carix'); ?>',
                data: {
                    cari: $(this).val()
                },
                dataType: 'json',
        ...
        $('body').on('change', '.NO_DO', function() {
            ...
            $.ajax({
                type: 'post',
                url: '<?= base_url('admin/DataPMS_ValidasiPesanan/edit'); ?>',
                data: {
