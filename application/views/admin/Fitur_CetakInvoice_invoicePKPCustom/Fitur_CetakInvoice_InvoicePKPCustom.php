...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Fitur Cetak Invoice PKP Custom
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Fitur_CetakInvoice_InvoicePKPCustom/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="275px">No. SJ</th>
                        <th width="245px">Tgl</th>
                        <th width="275px">No So</th>
                        <th width="250px">Wilayah</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Fitur_CetakInvoice_InvoicePKPCustom/get_ajax_jual') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
