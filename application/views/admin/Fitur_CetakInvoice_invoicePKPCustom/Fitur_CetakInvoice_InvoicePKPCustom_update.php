<?php
foreach ($cetakinvoicepkpcustom as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="cetakinvoicepkpcustom" name="cetakinvoicepkpcustom" action="<?php echo base_url('admin/Fitur_CetakInvoice_InvoicePKPCustom/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($cetakinvoicepkpcustom as $row) :
							?>
								<tr>
