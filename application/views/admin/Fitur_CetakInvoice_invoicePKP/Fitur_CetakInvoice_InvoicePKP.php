...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Fitur Cetak Invoice PKP
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Fitur_CetakInvoice_InvoicePKP/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Fitur_CetakInvoice_InvoicePKP/get_ajax_jual') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
