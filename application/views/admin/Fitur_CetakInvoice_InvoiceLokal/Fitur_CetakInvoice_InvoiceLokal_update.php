<?php
foreach ($cetakinvoicelokal as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="cetakinvoicelokal" name="cetakinvoicelokal" action="<?php echo base_url('admin/Fitur_CetakInvoice_InvoiceLokal/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="input-group col-md-2">
							<input type="text" class="date form-control text_input" id="TGL" name="TGL" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->TGL_PMS, TRUE)); ?>">
						</div>
						<!-- <div class="col-md-1">
							<label class="label">No Sj </label>
						</div>
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($cetakinvoicelokal as $row) :
							?>
								<tr>
