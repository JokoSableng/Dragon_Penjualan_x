...
<div class="container-fluid">
	...
	<form id="transaksi_penerimaan_barang_mutasi" name="transaksi_penerimaan_barang_mutasi" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang_Mutasi/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
							...
							<tr>
								...
								<td>
									<div class="input-group">
										<select class="js-example-responsive-kd_brg form-control KD_BRG" name="KD_BRG[]" id="KD_BRG" onchange="kd_brg(this.id)" onfocusout="hitung()" required></select>
									</div>
								</td>
								...
								<td><input name="GOL[]" id="GOL" type="text" class="form-control GOL" maxlength="1" readonly></td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control TDISC rightJustified text-danger font-weight-bold" onfocusout="hitung()" onchange="hitung()" value="0" id="TDISC" name="DISC">
				</div>
			</div>
		</div>
		<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		var akun0 = "<div class='input-group'><select class='js-example-responsive-kd_brg form-control KD_BRG' name='KD_BRG[]' id=KD_BRG" + idrow + " onchange='kd_brg(this.id)' onfocusout='hitung()' required></select></div>";
		var akun = akun0;
...
<script>
	...
	function select_kd_brg() {
		$('.js-example-responsive-kd_brg').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Penerimaan_Barang_Mutasi/getDataAjax_Brg') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
