...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang_Mutasi/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="210px">No Sj</th>
                        <th width="225px">Tanggal</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Penerimaan_Barang_Mutasi/get_ajax_stockb') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
