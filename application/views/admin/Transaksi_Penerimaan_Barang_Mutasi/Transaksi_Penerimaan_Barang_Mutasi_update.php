<?php
	foreach ($penerimaan_barang_mutasi as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="transaksi_penerimaan_barang_mutasi" name="transaksi_penerimaan_barang_mutasi" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang_Mutasi/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="input-group col-md-3">
							...
							<input class="form-control text_input NOLPBM" id="NOLPBM" name="NOLPBM" type="text" value="<?php echo $rowh->NOLPBM ?>" readonly>
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-3">
							<input 
								...
								value="<?php echo date('d-m-Y', strtotime($rowh->TGLLPBM, TRUE)); ?>"
								onclick="select()" 
							>
						</div>
					</div>
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($penerimaan_barang_mutasi as $row) : 
						?>
							<tr>
...
<script>
	...
	function select2x() {
		$('.js-example-responsive').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Penerimaan_Barang_Mutasi/getDataAjax_Article') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
