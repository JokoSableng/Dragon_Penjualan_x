...
<div class="container-fluid">
	...
	<form id="penjualanlain" name="penjualanlain" action="<?php echo base_url('admin/Transaksi_PenjualanLain/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input class="form-control text_input NO_SURAT" id="NO_SURAT" name="NO_SURAT" type="text" value="<?php echo $rowh->NO_SURAT ?>">
						</div>
						<div class="col-md-1">
							<label class="label">Tgl SJ </label>
						</div>
						<div class="col-md-2">
							<input type="text" class="date form-control text_input" id="TGL_SJ" name="TGL_SJ" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->TGL_SJ, TRUE)); ?>" onclick="select()">
						</div>
					</div>
				</div>
				<div class="col-md-12">
