<?php
foreach ($konfirmasipesanansheet as $rowh) {
};
?>
...
<div class="container-fluid">
    ...
    <form id="konfirmasipesanansheet" name="konfirmasipesanansheet" action="<?php echo base_url('admin/Transaksi_KonfirmasiPesananSheet/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="table-responsive scrollable">
                    <table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            foreach ($konfirmasipesanansheet as $row) :
                            ?>
                                <tr>
