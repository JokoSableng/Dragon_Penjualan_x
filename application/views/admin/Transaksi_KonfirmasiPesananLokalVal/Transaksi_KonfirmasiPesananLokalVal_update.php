...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-container" role="alert">
		<i class="fas fa-university"></i> Update Transaksi Konfirmasi Lokal Sheet Val
	</div>
	<br>
	<form id="konfirmasipesananlokalval" name="konfirmasipesananlokalval" action="<?php echo base_url('admin/Transaksi_KonfirmasiPesananLokalVal/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="col-md-12">
