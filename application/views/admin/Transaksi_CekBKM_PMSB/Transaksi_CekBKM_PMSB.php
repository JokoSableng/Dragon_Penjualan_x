...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Cek BKM PMS B
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_CekBKM_PMSB/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        var wilayah = $('#example').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_CekBKM_PMSB/get_ajax_jl_piu') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
