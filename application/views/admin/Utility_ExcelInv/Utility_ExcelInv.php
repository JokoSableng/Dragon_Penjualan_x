...
<section>
    <div class="container-fluid">
        ...
        <br>
        <form method="post" action="<?php echo base_url('admin/Utility_ExcelInv/index_Utility_ExcelInv') ?>">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
        ...
        <form method="post" action="<?php echo base_url('admin/Utility_ExcelInv/update') ?>">
            <table id="example" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    foreach ($utility_excelinv as $utility_excelinvd) :
                    ?>
                        <tr>
                            <td class="text_input"><?php echo $utility_excelinvd->PER ?></td>
                            <td class="text_input"><?php echo $utility_excelinvd->WILAYAH ?></td>
                            <td class="text_input"><?php echo $utility_excelinvd->NO_BUKTI ?></td>
                            <td class="text_input"><?php echo $utility_excelinvd->TGL_FKTR ?></td>
                            <td class="text_input"><?php echo $utility_excelinvd->INVOICE ?></td>
                            <td style="color: blue; text-align: right; font-weight: bold;"><?php echo number_format($utility_excelinvd->TOTAL, 2, '.', ','); ?></td>
                        </tr>
                    <?php
                        $no++;
                    endforeach;
