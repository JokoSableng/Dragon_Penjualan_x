...
<div class="container-fluid">
	...
	<form id="penjualanpmsjateng" name="penjualanpmsjateng" action="<?php echo base_url('admin/Transaksi_Penjualan_PenjualanPMSJateng/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Penjualan_PenjualanPMSJateng/filter_no_surat'); ?>',
