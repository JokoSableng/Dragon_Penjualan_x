...
<section>
    <div class="container-fluid">
        ...
        <br>
        <form method="post" id="entri" action="<?php echo base_url('admin/Fitur_Excel_Excel7/index_Fitur_Excel_Excel7') ?>" enctype="multipart/form-data">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <div class="col-md-1">
                                <label class="label">Import Excel </label>
                            </div>
                            <div class="col-md-3">
                                <input type="file" name="fileimpor" class="form-control" id="file">
                            </div>
                            <div class="col-md-1">
                                <input class="btn btn-primary btn-block" type="submit" name="ambil" value="Import" onclick="importExcel()">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <form method="post" action="<?php echo base_url('admin/Fitur_Excel_Excel7/update') ?>">
            <table id="example" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    foreach ($fitur_excel7 as $fitur_excel7d) :
                    ?>
                        <tr>
                            <td class="text_input"><?php echo $fitur_excel7d->NO_BUKTI ?></td>
                            <td class="text_input"><?php echo $fitur_excel7d->TGL ?></td>
                            <td class="text_input"><?php echo $fitur_excel7d->FIX ?></td>
                        </tr>
                    <?php
                        $no++;
                    endforeach;
