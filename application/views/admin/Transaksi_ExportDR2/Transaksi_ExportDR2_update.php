...
<div class="container-fluid">
	...
	<form id="exportdr2" name="exportdr2" action="<?php echo base_url('admin/Transaksi_ExportDR2/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
