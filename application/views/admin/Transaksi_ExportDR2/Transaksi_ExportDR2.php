...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Export DR 2
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_ExportDR2/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_ExportDR2/get_ajax_jual') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
