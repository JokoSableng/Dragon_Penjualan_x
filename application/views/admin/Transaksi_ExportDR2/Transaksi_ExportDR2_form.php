...
<div class="container-fluid">
	...
	<form id="exportdr2" name="exportdr2" action="<?php echo base_url('admin/Transaksi_ExportDR2/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_ExportDR2/filter_no_surat'); ?>',
				data: {
					no_surat: no_surat
				},
				dataType: 'json',
