...
<section>
    <div class="container-fluid">
        ...
        <br>
        <form method="post" id="entri" action="<?php echo base_url('admin/Fitur_CekInvoice/index_Fitur_CekInvoice') ?>">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <select class="js-example-responsive form-control NO_BUKTI_1 text_input" name="NO_BUKTI_1" id="NO_BUKTI_1" style="width: 100%;" onchange="cari()">
                                    <?php
                                    if (isset($_POST["NO_BUKTI_1"]) == $NO_BUKTI_1) {
                    ...
                    <!-- <div class="col-md-12">
                        <div class="form-group row">
                            <div class="col-md-1">
                                <label class="label">Kodec </label>
                            </div>
                            <div class="col-md-2">
                                <select class="js-example-responsive form-control KODEC_1 text_input" name="KODEC_1" id="KODEC_1" style="width: 100%;">
                                    <?php /*
                                    if (isset($_POST["tampilkan"]) &&  $_POST["KODEC_1"] == $KODEC_1) {
                                        echo '<option value="' . $KODEC_1 . '" selected >' . $KODEC_1 . '</option>';
                                    } */?>
                                </select>
                            </div>
                            <div class="col-md-7">
        ...
        <form method="post" action="<?php echo base_url('admin/Fitur_CekInvoice/update') ?>">
            <table id="batal_pp" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    foreach ($fitur_cekinvoice as $fitur_cekinvoiced) :
                    ?>
                        <tr>
                            <!-- <td class="text_input"><?php //echo $fitur_cekinvoiced->PER ?></td> -->
                            <td class="text_input"><?php echo $fitur_cekinvoiced->NO_BUKTI ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->KODEC ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->NAMAC ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->INVOICE ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->TGL_FKTR ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->NO_FKTR ?></td>
                            <td class="text_input"><?php echo $fitur_cekinvoiced->NETT ?></td>
                        </tr>
                    <?php
                        $no++;
                    endforeach;
...
<script>
    ...
    function select_no_bukti_1() {
        $('#NO_BUKTI_1').select2({
            ajax: {
                url: "<?= base_url('admin/Fitur_CekInvoice/getData_bukti') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
    ...
    function select_kodec_1() {
        $('#KODEC_1').select2({
            ajax: {
                url: "<?= base_url('admin/Fitur_CekInvoice/getData_cust') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
                data: function(params) {
