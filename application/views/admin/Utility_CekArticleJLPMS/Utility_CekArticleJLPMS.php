...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-container" role="alert">
            <i class="fas fa-university"></i> Cek Article JLPMS
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="entri" method="post" action="<?php echo base_url('admin/Utility_CekArticleJLPMS/index_Utility_CekArticleJLPMS') ?>">
            <br>
            <div class="col-md-12">
        ...
        <table id="utility_copy" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
            ...
            <tbody>
                <?php
                $no = 0;
                foreach ($utility_CekArticleJLPMS as $detail) :
                ?>
                    <tr>
                        <td class="text_input"><?php echo $detail->KD_BRG ?></td>
                        <td class="text_input"><?php echo $detail->DISCRP ?></td>
                        <td class="text_input"><?php echo $detail->WARNA ?></td>
                    </tr>
                <?php
                    $no++;
                endforeach;
    ...
    $(document).ready(function() {
        ...
        $('#utility_copy').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    filename: 'utility_CekArticleJLPMS', 
                    title: '',
                    text: 'Export Excel',
                },
            ],
