...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            ...
            <i class="fas fa-university"></i> Cek Article JL PMS
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="CekArticleJLPMS" method="post" action="<?php echo base_url('admin/Utility_CekArticleJLPMS/index_Utility_CekArticleJLPMS') ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <select class="form-control option" name="option" id="option" style="width: 100%;">
                            ...
                            <option value="1">Combo Box 1</option>
                            <option value="2">Combo Box 2</option>
                        </select>
                    </div>
                </div>
            </div>
