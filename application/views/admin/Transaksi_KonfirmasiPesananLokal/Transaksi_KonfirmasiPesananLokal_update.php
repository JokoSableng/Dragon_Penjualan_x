<?php
foreach ($konfirmasipesananlokal as $rowh) {
};
?>
...
<div class="container-fluid">
    ...
    <form id="konfirmasipesananlokal" name="konfirmasipesananlokal" action="<?php echo base_url('admin/Transaksi_KonfirmasiPesananLokal/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="table-responsive scrollable">
                    <table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            foreach ($konfirmasipesananlokal as $row) :
                            ?>
                                <tr>
                                    ...
                                    <td><input name="TGL_SJ[]" id="TGL_SJ<?php echo $no; ?>" type="text" class="form-control text_input" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($row->TGL_SJ, TRUE)); ?>" readonly></td>
                                    ...
                                    <td><input name="HARGAP[]" onclick="select()" onkeyup="hitung()" id="HARGAP<?php echo $no; ?>" value="<?php echo number_format($row->HARGAP, 2, '.', ','); ?>" type="text" class="form-control HARGAP rightJustified text-primary" readonly></td>
                                    ...
                                    <td>
                                        <input <?php
                                                if ($row->TTD1 == 1) echo 'checked onclick="return false;"'; ?> name="TTD1[]" id="TTD1<?php echo $no; ?>" type="checkbox" value="<?= $row->TTD1 ?>" class="checkbox_container TTD1">
                                    </td>
                                    <td>
        ...
        <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input class="form-control text_input FRANCO" id="FRANCO" name="FRANCO" type="text" value="<?php echo $rowh->FRANCO ?>" readonly>
                </div>
                ...
                <div class="col-md-2 ">
                    <input class="form-control KURS rightJustified text-primary font-weight-bold" value="<?php echo number_format($rowh->KURS, 2, '.', ','); ?>" id="KURS" name="KURS" readonly>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input class="form-control text_input PAYMENT" id="PAYMENT" name="PAYMENT" type="text" value="<?php echo $rowh->PAYMENT ?>" readonly>
                </div>
                <div class="col-md-6"></div>
                <div class="col-md-1">
