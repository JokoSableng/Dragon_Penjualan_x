<?php
foreach ($penjualanexport as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="penjualanexport" name="penjualanexport" action="<?php echo base_url('admin/Transaksi_PenjualanExport/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input type="text" class="date form-control text_input" id="TGL_SJ" name="TGL_SJ" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->TGL_SJ, TRUE)); ?>" onclick="select()" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($penjualanexport as $row) :
							?>
								<tr>
			...
			<div class="modal-body">
				<table class='table table-bordered' id='modal_no_sj'>
					...
					<tbody>
						...
						?>
							<tr>
								<td class='NSSVAL'><a href="#" class="select_no_sj"><?php echo $b->NO_SJ; ?></a></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_sj', function() {
			...
			target.parents("div").find(".NO_SJ").val(val);
