<?php
	foreach ($retur_penjualanexport as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="returpenjualanexport" name="returpenjualanexport" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanExport/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input class="form-control text_input NO_JUAL" id="NO_JUAL" name="NO_JUAL" type="text" value="<?php echo $rowh->NO_JUAL ?>" readonly>
						</div>
                        <div class="col-md-1">
							<label class="label">Tgl Jual </label>
						</div>
						<div class="col-md-2">
							<input class="form-control text_input TGL_JUAL" id="TGL_JUAL" name="TGL_JUAL" type="text" value="<?php echo $rowh->TGL_JUAL ?>" readonly>
						</div>
					</div>
				</div>
                <div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
                            <input class="form-control text_input NO_SURAT" id="NO_SURAT" name="NO_SURAT" type="text" value="<?php echo $rowh->NO_JUAL ?>" readonly>
						</div>
						<div class="col-md-1">
					...
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input 
								...
								name="TGL_FKTR" 
								data-date-format="dd-mm-yyyy" 
								value="<?php echo date('d-m-Y', strtotime($rowh->TGL_FKTR, TRUE)); ?>"
								onclick="select()" 
							>
						</div>
                        <div class="col-md-1">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <?php
							$no = 0;
							foreach ($retur_penjualanexport as $row) : 
						?>
							<tr>
								...
								<td><input name="KET3[]" id="KET3<?php echo $no; ?>" value="<?= $row->KET3 ?>" type="text" class="form-control KET3 text_input"></td>
								<td><input name="USD[]" onclick="select()" onkeyup="hitung()" id="USD<?php echo $no; ?>" value="<?php echo number_format($row->USD, 2, '.', ','); ?>" type="text" class="form-control USD rightJustified text-primary" readonly></td>
								<td><input name="USDP[]" onclick="select()" onkeyup="hitung()" id="USDP<?php echo $no; ?>" value="<?php echo number_format($row->USDP, 2, '.', ','); ?>" type="text" class="form-control USDP rightJustified text-primary" readonly></td>
								<td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control RATE rightJustified text-primary font-weight-bold" onchange="hitung()" value="<?php echo number_format($rowh->RATE, 2, '.', ','); ?>" id="RATE" name="RATE" readonly>
				</div>
				<div class="col-md-1">
