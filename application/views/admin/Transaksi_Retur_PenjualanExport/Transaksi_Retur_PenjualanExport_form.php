...
<div class="container-fluid">
	...
	<form id="returpenjualanexport" name="returpenjualanexport" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanExport/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						<thead>
							<tr>
								...
								<th width="150px">Ket 3</th>
								<th width="100px">USD</th>
                                <th width="100px">USD Pair</th>
								<th width="1px"></th>
							</tr>
						</thead>
						<tbody id="show-data">
							<tr>
								...
								<td><input name="KET3[]" id="KET30" type="text" class="form-control KET3 text_input"></td>
								<td><input name="USD[]" onclick="select()" onkeyup="hitung()" value="0" id="USD0" type="text" class="form-control USD rightJustified text-primary" readonly></td>
								<td><input name="USDP[]" onclick="select()" onkeyup="hitung()" value="0" id="USDP0" type="text" class="form-control USDP rightJustified text-primary" readonly></td>
								<!-- <td>
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#USD" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
			$("#USDP" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
		}
		...
		$('body').on('click', '.select_no_jual', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Retur_PenjualanExport/filter_no_jual'); ?>',
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="KET3[]" value="" id=KET3'+i+' type="text" class="form-control KET3 text_input"></td>'+
									'<td><input name="USD[]" value="0" id=USD'+i+' type="text" class="form-control USD rightJustified text-primary" readonly></td>'+
									'<td><input name="USDP[]" value="0" id=USDP'+i+' type="text" class="form-control USDP rightJustified text-primary" readonly></td>'+
								'</tr>';
                    }
					idrow=i;
					$('#show-data').html(html);
					...
					for(i=0; i<=jumlahdata; i++){
						...
						$("#USD" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#USDP" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
					}
