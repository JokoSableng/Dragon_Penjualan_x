...
<div class="container-fluid">
	...
	<form id="penjualanum" name="penjualanum" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanUM/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1">
							<label class="label">No Jual </label>
						</div>
						<div class="col-md-2 input-group">
							<input name="NO_JUAL" id="NO_JUAL" type="text" class="form-control NO_JUAL text_input" onkeypress="return tabE(this,event)" readonly>
							<span class="input-group-btn">
								<a class="btn default" onfocusout="hitung()" id="0" data-target="#mymodal_no_jual" data-toggle="modal" href="#lupjual" ><i class="fa fa-search"></i></a>
							</span>
						</div>
                        <div class="col-md-1">
							<label class="label">Tgl Jual </label>
						</div>
						<div class="col-md-2">
							<input class="form-control text_input TGL_JUAL" id="TGL_JUAL" name="TGL_JUAL" type="text" value='' readonly>
						</div>
					</div>
				</div>
                <div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
                            <input class="form-control text_input NO_SURAT" id="NO_SURAT" name="NO_SURAT" type="text" value='' readonly>
						</div>
                        <div class="col-md-1">
							<label class="label">Tgl SJ </label>
						</div>
						<div class="col-md-2">
                            <input class="form-control text_input TGL_SJ" id="TGL_SJ" name="TGL_SJ" type="text" value=''>
						</div>
						<div class="col-md-1">
					...
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input 
								...
								name="TGL_FKTR" 
								data-date-format="dd-mm-yyyy" 
								value="<?php if (isset($_POST["tampilkan"])) { echo $_POST["TGL_FKTR"]; } else echo date('d-m-Y'); ?>" 
								onclick="select()" 
							>
						</div>
                        <div class="col-md-1">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						<thead>
							<tr>
								...
								<th width="150px">Ket 1</th>
								<th width="150px">Ket 2</th>
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="NA_BRG[]" id="NA_BRG0" type="text" class="form-control NA_BRG text_input" readonly></td>
								<td><input name="QTY[]" onclick="select()" onkeyup="hitung()" value="0" id="QTY0" type="text" class="form-control QTY rightJustified text-primary" readonly></td>
								...
								<td><input name="DISC1[]" onclick="select()" onkeyup="hitung()" value="0" id="DISC10" type="text" class="form-control DISC1 rightJustified text-danger" readonly></td>
								<td><input name="DISC2[]" onclick="select()" onkeyup="hitung()" value="0" id="DISC20" type="text" class="form-control DISC2 rightJustified text-danger" readonly></td>
								<td><input name="DISC3[]" onclick="select()" onkeyup="hitung()" value="0" id="DISC30" type="text" class="form-control DISC3 rightJustified text-danger" readonly></td>
								<td><input name="DISC4[]" onclick="select()" onkeyup="hitung()" value="0" id="DISC40" type="text" class="form-control DISC4 rightJustified text-danger" readonly></td>
								<td><input name="DISCRP[]" onclick="select()" onkeyup="hitung()" value="0" id="DISCRP0" type="text" class="form-control DISCRP rightJustified text-danger" readonly></td>
								...
								<td><input name="ORDERNO[]" id="ORDERNO0" type="text" class="form-control ORDERNO text_input"></td>
								<!-- <td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_jual', function() {
			...
			var no_jual = $(this).parents("tr").find(".NJJVAL").text();
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Retur_PenjualanUM/filter_no_jual'); ?>',
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="NA_BRG[]" value="'+response[i].NA_BRG+'" id=NA_BRG'+i+' type="text" class="form-control NA_BRG text_input" readonly></td>'+
									'<td><input name="QTY[]" value="'+numberWithCommas(response[i].QTY)+'" id=QTY'+i+' type="text" class="form-control QTY rightJustified text-primary" readonly></td>'+
									...
									'<td><input name="KET2[]" value="" id=KET2'+i+' type="text" class="form-control KET2 text_input"></td>'+
									'<td><input name="ORDERNO[]" value="" id=ORDERNO'+i+' type="text" class="form-control ORDERNO text_input"></td>'+
								'</tr>';
                    }
					idrow=i;
					$('#show-data').html(html);
					...
					for(i=0; i<=jumlahdata; i++){
						...
						$("#QTYP" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#HARGA" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#HARGAP" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISC" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISC1" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISC2" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISC3" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISC4" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
						$("#DISCRP" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
