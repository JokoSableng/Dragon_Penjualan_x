<?php
	foreach ($retur_penjualanum as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="penjualanum" name="penjualanum" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanUM/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
                ...
                <div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
                            <input class="form-control text_input TGL_SJ" id="TGL_SJ" name="TGL_SJ" type="text" value="<?php echo $rowh->TGL_SJ ?>">
						</div>
						<div class="col-md-1">
                ...
                <div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
                            <input class="form-control text_input INVOICE" id="INVOICE" name="INVOICE" type="text" INVOICE>
						</div>
						<div class="col-md-1">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <?php
							$no = 0;
							foreach ($retur_penjualanum as $row) : 
						?>
							<tr>
								...
								<td><input name="ORDERNO[]" id="ORDERNO<?php echo $no; ?>" value="<?= $row->ORDERNO ?>" type="text" class="form-control ORDERNO text_input"></td>
								<td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control TTOTAL rightJustified text-primary font-weight-bold" onchange="hitung()" value="<?php echo number_format($rowh->TOTAL_QTY, 2, '.', ','); ?>" id="TTOTAL" name="TTOTAL" readonly>
				</div> -->
				<div class="col-md-1">
