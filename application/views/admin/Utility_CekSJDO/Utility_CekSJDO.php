...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-container" role="alert">
            <i class="fas fa-university"></i> Cek SJ DO
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="entri" method="post" action="<?php echo base_url('admin/Utility_CekSJDO/index_Utility_CekSJDO') ?>">
            <br>
            <div class="col-md-12">
        ...
        <table id="utility_copy" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
            ...
            <tbody>
                <?php
                $no = 0;
                foreach ($utility_CekSJDO as $detail) :
                ?>
                    <tr>
                        <td class="text_input"><?php echo $detail->KD_BRG ?></td>
                        <td class="text_input"><?php echo $detail->QTYSP ?></td>
                        <td class="text_input"><?php echo $detail->QTYSJ ?></td>
                    </tr>
                <?php
                    $no++;
                endforeach;
