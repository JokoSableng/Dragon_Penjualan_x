...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            ...
            <i class="fas fa-university"></i> Cek Nomor SJ DO
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="CekSJDO" method="post" action="<?php echo base_url('admin/Utility_CekSJDO/index_Utility_CekSJDO') ?>">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input class="form-control text_input wilayah" id="wilayah" name="wilayah" type="text" value=''>
                    </div>
                </div>
            </div>
            <!-- Batas ganti 3 -->
