...
<div class="container-fluid">
	...
	<form id="penjualanum" name="penjualanum" action="<?php echo base_url('admin/Transaksi_PenjualanUM/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input name="ORDERNO[]" id="KD_BRG<?php echo $no; ?>" value="<?= $row->KD_BRG ?>" type="text" class="form-control ORDERNO text_input"></td>
									<td>
