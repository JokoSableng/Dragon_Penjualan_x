...
<div class="container-fluid">
	...
	<form id="proformainvoice" name="proformainvoice" action="<?php echo base_url('admin/Transaksi_ProformaInvoice/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
