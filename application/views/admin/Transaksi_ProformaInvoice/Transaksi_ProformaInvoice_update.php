<?php
foreach ($proformainvoice as $rowh) {
};
?>
...
<div class="container-fluid">
    ...
    <form id="proformainvoice" name="proformainvoice" action="<?php echo base_url('admin/Transaksi_ProformaInvoice/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="table-responsive scrollable">
                    <table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            foreach ($proformainvoice as $row) :
                            ?>
                                <tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.select_no_so', function() {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo base_url('index.php/admin/Transaksi_ProformaInvoice/filter_no_so'); ?>',
                data: {
                    no_so: no_so
                },
