...
<div class="container-fluid">
	...
	<form id="transaksi_stok_opname" name="transaksi_stok_opname" action="<?php echo base_url('admin/Transaksi_Stok_Opname/lihat_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="input-group col-md-3">
							...
							<input class="form-control text_input NOOPN" id="NOOPN" name="NOOPN" type="text" value="<?php echo $rowh->NOOPN ?>" readonly>
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-3">
							<input 
								type="text" 
								class="date form-control TGLOPN" 
								id="TGLOPN" 
								name="TGLOPN" 
								data-date-format="dd-mm-yyyy" 
								value="<?php echo date('d-m-Y', strtotime($rowh->TGLOPN, TRUE)); ?>"
								onclick="select()" 
                                readonly
							>
						</div>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control DISC rightJustified text-danger font-weight-bold" onfocusout="hitung()" onchange="hitung()" value="<?php echo number_format($row->DISC, 2, '.', ','); ?>" id="DISC" name="DISC"readonly>
				</div>
			</div>
		</div>
		<div class="col-md-12">
...
<script>
	...
	function select2x() {
		$('.js-example-responsive').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Stok_Opname/getDataAjax_Article') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
