...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            ...
            <i class="fas fa-university"></i> Postingan Surat Jalan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="PostinganSJ" method="post" action="<?php echo base_url('admin/Utility_PostinganSJ/index_Utility_PostinganSJ') ?>">
