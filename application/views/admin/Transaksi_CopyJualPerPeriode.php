...
<section>
	<div class="container-fluid">
		...
		<div class="alert alert-success alert-container" role="alert">
			<i class="fas fa-university"></i> Transaksi Copy Jual Per Periode
		</div>
		<?php echo $this->session->flashdata('pesan') ?>
		<form id="transaksi_copyjualperperiode" method="post" action="<?php echo base_url('admin/Transaksi_CopyJualPerPeriode/index_Transaksi_CopyJualPerPeriode') ?>">
			<div class="col-md-12">
			...
			<div class="report-content">
				...
				DataTables::create(array(
					"dataStore" => $transaksi_copyjualperperiode,
					"name" => "example",
					"fixedHeader" => true,
					"showFooter" => true,
					"showFooter" => "bottom",
