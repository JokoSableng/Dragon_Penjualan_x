...
<div class="container-fluid">
	...
	<form id="cekbkk_bkk" name="cekbkk_bkk" action="<?php echo base_url('admin/Transaksi_CekBKK_BKK/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
