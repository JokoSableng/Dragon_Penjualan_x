...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_CekBKK_BBMBG/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        var wilayah = $('#example').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_CekBKK_BBMBG/get_ajax_jl_piu') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
