...
<div class="container-fluid">
	...
	<form id="cekbkk_bbmbg" name="cekbkk_bbmbg" action="<?php echo base_url('admin/Transaksi_CekBKK_BBMBG/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function select_wilayah() {
		$('.js-example-responsive-wilayah').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_CekBKK_BBMBG/getDataAjax_wilayah') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
	...
	function select_kodec() {
		...
		$('.js-example-responsive-kodec').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_CekBKK_BBMBG/getDataAjax_cust') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
				data: function(params) {
	...
	function select_no_surat() {
		...
		$('.js-example-responsive-no_surat').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_CekBKK_BBMBG/getDataAjax_no_surat') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
				data: function(params) {
