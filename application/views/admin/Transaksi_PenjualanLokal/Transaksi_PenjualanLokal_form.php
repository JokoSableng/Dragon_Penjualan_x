...
<div class="container-fluid">
	...
	<form id="penjualanlokal" name="penjualanlokal" action="<?php echo base_url('admin/Transaksi_PenjualanLokal/input_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_PenjualanLokal/filter_no_surat'); ?>',
				data: {
					no_surat: no_surat
				},
				dataType: 'json',
