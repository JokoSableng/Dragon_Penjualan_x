<?php
foreach ($penjualanlokal as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="penjualanlokal" name="penjualanlokal" action="<?php echo base_url('admin/Transaksi_PenjualanLokal/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input class="form-control text_input NO_SURAT" id="NO_SURAT" name="NO_SURAT" type="text" value="<?php echo $rowh->NO_PO ?>">
						</div>
						<div class="col-md-1">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1">
							<div class="col-md-6">
								<input class="form-control text_input PKP" id="PKP" name="PKP" type="text" value="<?php echo $rowh->NOTES ?>">
							</div>
						</div>
						<div class="col-md-4">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input class="form-control text_input NAMAC" id="NOTES" name="NOTES" type="text" value="<?php echo $rowh->NOTES ?>">
						</div>
						<div class="col-md-0">
						...
						<div class="col-md-1">
							<div class="col-md-6">
								<input class="form-control text_input TX" id="TX" name="TX" type="text" value="<?php echo $rowh->NOTES ?>">
							</div>
						</div>
						<div class="col-md-4">
