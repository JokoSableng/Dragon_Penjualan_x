...
<div class="container-fluid">
	...
	<form id="pengajuanbmpk" name="pengajuanbmpk" action="<?php echo base_url('admin/Transaksi_PengajuanBMPK/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input name="WILAYAH[]" id="WILAYAH<?php echo $no; ?>" value="<?= $row->WILAYAH ?>" type="text" class="form-control WILAYAH text_input" readonly></td>
									<td><input name="BMPKL[]" id="BMPKL<?php echo $no; ?>" value="<?= $row->BMPKL ?>" type="text" class="form-control BMPKL text_input" readonly></td>
									<td><input name="BMPKB[]" id="BMPKB<?php echo $no; ?>" value="<?= $row->BMPKB ?>" type="text" class="form-control BMPKB text_input"></td>
									<td><input name="MET_BYR[]" id="MET_BYR<?php echo $no; ?>" value="<?= $row->MET_BYR ?>" type="text" class="form-control MET_BYR text_input"></td>
									<td><input name="PERIODE2[]" id="PERIODE2<?php echo $no; ?>" value="<?= $row->PERIODE2 ?>" type="text" class="form-control PERIODE2 text_input"></td>
									<td><input name="NOTES[]" id="NOTES<?php echo $no; ?>" value="<?= $row->NOTES ?>" type="text" class="form-control NOTES text_input"></td>
									<td>
