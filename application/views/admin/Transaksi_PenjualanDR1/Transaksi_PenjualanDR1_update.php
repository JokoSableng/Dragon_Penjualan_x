...
<div class="container-fluid">
	...
	<form id="penjualandr1" name="penjualandr1" action="<?php echo base_url('admin/Transaksi_PenjualanDR1/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input class="form-control text_input NAMAC" id="NAMAC" name="NAMAC" type="text" value="<?php echo $rowh->NAMAC ?>">
						</div>
						<div class="col-md-4">
