...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> KROSCEK SJ DO
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rincianpenjualanwilayah" method="post" action="<?php echo base_url('admin/Utility_CrosscheckDOSJ/index_Utility_CrosscheckDOSJToko') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3 nopadding">
                        <input type="text" value="" class="form-control form-control-user" id="PER"  name="PER">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $rincian_penjualan_wilayah,
                    "name" => "example",
                    "showFooter"=>true,
                    "showFooter"=>"bottom",
                    "columns" => array(
