<?php
	foreach ($retur_penjualanlain as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="returpenjualanlain" name="returpenjualanlain" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanLain/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
                ...
                <div class="col-md-12">
					<div class="form-group row">
                        ...
                        <div class="col-md-1">
							<label class="label">Tgl Surat </label>
						</div>
						<div class="col-md-2">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($retur_penjualanlain as $row) : 
						?>
							<tr>
								...
								<td><input name="GOL[]" id="GOL<?php echo $no; ?>" value="<?= $row->GOL ?>" type="text" class="form-control GOL text_input" readonly></td>
								<td><input name="SATUAN[]" id="SATUAN<?php echo $no; ?>" value="<?= $row->SATUAN ?>" type="text" class="form-control SATUAN text_input" readonly></td>
								<td><input name="METER[]" id="METER<?php echo $no; ?>" value="<?= $row->METER ?>" type="text" class="form-control METER text_input" readonly></td>
								...
								<td><input name="DISC[]" onclick="select()" onkeyup="hitung()" id="DISC<?php echo $no; ?>" value="<?php echo number_format($row->DISC, 2, '.', ','); ?>" type="text" class="form-control DISC rightJustified text-danger"></td>
		...
		<div class="col-md-12">
			...
			<div class="col-md-1">
				...
				<div class="col-md-2 ">
					<input class="form-control SISA rightJustified text-primary font-weight-bold" onchange="hitung()" value="<?php echo number_format($rowh->NETT, 2, '.', ','); ?>" id="SISA" name="SISA" readonly>
				</div>
				<div class="col-md-1">
