...
<div class="container-fluid">
	...
	<form id="returpenjualanlain" name="returpenjualanlain" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanLain/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_jual', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Retur_PenjualanLain/filter_no_jual'); ?>',
