...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-container" role="alert">
		<i class="fas fa-university"></i> Update Master Artikel
	</div>
	<br>
	<form id="article" name="article" action="<?php echo base_url('admin/Master_Article/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="col-md-12">
