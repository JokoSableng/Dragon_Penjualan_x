<?php
	foreach ($retur_penjualanpms as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="returpenjualanpms" name="returpenjualanpms" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanPMS/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                        ...
                        <?php
							$no = 0;
							foreach ($retur_penjualanpms as $row) : 
						?>
							<tr>
