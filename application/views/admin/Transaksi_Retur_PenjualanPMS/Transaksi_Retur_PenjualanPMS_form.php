...
<div class="container-fluid">
	...
	<form id="returpenjualanpms" name="returpenjualanpms" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanPMS/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_jual', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Retur_PenjualanPMS/filter_no_jual'); ?>',
