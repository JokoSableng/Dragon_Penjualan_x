...
<div class="container-fluid">
	...
	<form id="pembayaranbkm" name="pembayaranbkm" action="<?php echo base_url('admin/Transaksi_PembayaranBKM/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
