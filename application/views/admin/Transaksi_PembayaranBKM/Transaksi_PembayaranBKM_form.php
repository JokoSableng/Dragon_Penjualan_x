...
<div class="container-fluid">
	...
	<form id="pembayaranbkm" name="pembayaranbkm" action="<?php echo base_url('admin/Transaksi_PembayaranBKM/input_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		td3.innerHTML = "<input name='INVOICE[]' id=INVOICE0" + idrow + " type='text' class='form-control INVOICE text_input' readonly>";
		...
		td6.innerHTML = "<input name='TGL_FKTR[]' id=TGL_FKTR0" + idrow + " type='text' class='form-control TGL_FKTR text_input' readonly>";
		td7.innerHTML = "<input name='TGL_SURAT[]' id=TGL_SURAT0" + idrow + " type='text' class='form-control TGL_SURAT text_input' readonly>";
...
<script>
	...
	function select_wilayah() {
		$('.js-example-responsive-wilayah').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_PembayaranBKM/getDataAjax_wilayah') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
	...
	function select_kodec() {
		...
		$('.js-example-responsive-kodec').select2({
			ajax: {
				url: "<?php //echo base_url('admin/Transaksi_PembayaranBKM/getDataAjax_cust') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
				data: function(params) {
	...
	function select_no_surat() {
		...
		$('.js-example-responsive-no_surat').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_PembayaranBKM/getDataAjax_no_surat') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
				data: function(params) {
