...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Master_ArticleSheet/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="80px">No</th>
                        <th width="225px">Kode Brg</th>
                        <th width="395px">Nama Brg</th>
                        <th width="200px">Gol</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Master_ArticleSheet/get_ajax_brg') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
