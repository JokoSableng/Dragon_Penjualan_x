...
<div class="container-fluid">
	...
	<form id="returpenjualanlokal" name="returpenjualanlokal" action="<?php echo base_url('admin/Transaksi_Retur_PenjualanLokal/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_jual', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Retur_PenjualanLokal/filter_no_jual'); ?>',
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="KET1[]" value="'+response[i].KET1+'" id=KET1'+i+' type="text" class="form-control KET1 text_input" readonly></td>'+
									'<td><input name="KET2[]" value="'+response[i].KET2+'" id=KET2'+i+' type="text" class="form-control KET2 text_input" readonly></td>'+
								'</tr>';
                    }
					idrow=i;
					$('#show-data').html(html);
