...
<div class="container-fluid">
	...
	<form id="transaksisuratjalanmutasi" name="transaksisuratjalanmutasi" action="<?php echo base_url('admin/Transaksi_Surat_Jalan_Mutasi/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1">
							<input class="form-control text_input KODERAY" id="KODERAY" name="KODERAY" type="text" value='' placeholder="Kode Rayon" readonly>
						</div>
						<div class="col-md-2">
							<input class="form-control text_input NAMAC" id="NAMAC" name="NAMAC" type="text" value='' placeholder="Nama Customer" readonly>
						</div>
						<div class="col-md-2">
				...
				<div class="col-md-12">
					<div class="form-group row">
						<div class="col-md-1">
							<label class="label">No SJM </label>
						</div>
						<div class="col-md-2 input-group">
							<input name="NO_SO" id="NO_SO" maxlength="30" type="text" class="form-control NO_SO text_input" onkeypress="return tabE(this,event)" readonly>
			...
			<div class="modal-body">
				<table class='table table-bordered' id='modal_no_so'>
					...
					<?php
						...
						$sql = "SELECT stockb.NO_BUKTI AS NO_SO, 
								stockb.TGL AS TGL_SO, 
								stockb.NO_DO AS NO_DO, 
								stockb.TGL_DO AS TGL_DO,
								stockb.TOTAL_QTY AS TOTAL_QTY,
								stockb.TOTAL_QTYP AS TOTAL_QTYP,
								stockb.KODEC AS KODEC,
								stockb.NAMAC AS NAMAC,
								stockb.KODERAY AS KODERAY,
								stockb.KOTA AS KOTA
							FROM stockb, stockbd
							WHERE stockb.NO_BUKTI=stockbd.NO_BUKTI
							AND stockb.WILAYAH = '$kdmts'
							AND stockb.PER  = '$per'
							AND stockb.REQ_DO = 0
							GROUP BY stockb.NO_BUKTI
							ORDER BY stockb.NO_BUKTI";
					...
					?>
						<tr>
							...
							<td class='TDSVAL text_input'><?php echo $b->TGL_DO;?></td>
							<td class='TQSVAL text_input'><?php echo $b->TOTAL_QTY;?></td>
							<td class='TPSVAL text_input'><?php echo $b->TOTAL_QTYP;?></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_so', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Surat_Jalan_Mutasi/filter_no_so'); ?>',
				data:{ no_so : no_so},
				dataType: 'json',
