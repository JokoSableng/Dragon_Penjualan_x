...
<section>
    <div class="container-fluid">
        ...
        <br>
        <form method="post" id="entri" action="<?php echo base_url('admin/Fitur_Excel_Excel4/index_Fitur_Excel_Excel4') ?>">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
        ...
        <form method="post" action="<?php echo base_url('admin/Fitur_Excel_Excel4/update') ?>">
            <table id="example" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    foreach ($fitur_excel4 as $fitur_excel4d) :
                    ?>
                        <tr>
                            <td class="text_input"><?php echo $fitur_excel4d->WILAYAH ?></td>
                            <td class="text_input"><?php echo $fitur_excel4d->TOTAL ?></td>
                        </tr>
                    <?php
                        $no++;
                    endforeach;
