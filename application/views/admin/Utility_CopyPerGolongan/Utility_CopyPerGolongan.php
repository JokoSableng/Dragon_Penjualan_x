...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-container" role="alert">
            <i class="fas fa-university"></i> Copy Per Golongan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="entri" method="post" action="<?php echo base_url('admin/Utility_CopyPerGolongan/index_Utility_CopyPerGolongan') ?>">
            <br>
            <div class="col-md-12">
        ...
        <table id="utility_copy" class="table table-bordered table-striped table-hover " style="width:100%; font-size: 13px">
            ...
            <tbody>
                <?php
                $no = 0;
                foreach ($utility_copypergolongan as $detail) :
                ?>
                    <tr>
    ...
    $(document).ready(function() {
        ...
        $('#utility_copy').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    filename: 'utility_copypergolongan', 
                    title: '',
                    text: 'Export Excel',
                },
            ],
