...
<div class="container-fluid">
	...
	<form id="transaksipenerimaanbarang" name="transaksipenerimaanbarang" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						?>
							<tr>
								...
								<td>
									<input 
										<?php 
											if ($row->TERIMA == "1") echo 'checked onclick="return false;"'
										;?>
										name="TERIMA[]" 
										id="TERIMA<?php echo $no; ?>" 
										type="checkbox" 
										value="<?= $row->TERIMA ?>" 
