...
<div class="container-fluid">
	...
	<form id="transaksipenerimaanbarang" name="transaksipenerimaanbarang" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang/lihat_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
