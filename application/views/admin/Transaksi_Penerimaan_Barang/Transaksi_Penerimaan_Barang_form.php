...
<div class="container-fluid">
	...
	<form id="transaksi_penerimaan_barang" name="transaksi_penerimaan_barang" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="input-group col-md-3">
							<input class="form-control text_input NOLPB" id="NOLPB" name="NOLPB" type="text" value='' readonly>
						</div>
						<div class="col-md-1">
							<label class="label">No Sj </label>
						</div>
						<div class="input-group col-md-3">
							<input class="form-control text_input NOSJ" id="NOSJ" name="NOSJ" type="text" value='' required>
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-3">
							<input 
								...
								value="<?php if (isset($_POST["tampilkan"])) { echo $_POST["TGLLPB"]; } else echo date('d-m-Y'); ?>" 
								onclick="select()" 
							>
						</div>
					</div>
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
							...
							<tr>
								...
								<td>
									<div class="input-group">
										<select class="js-example-responsive form-control ARTICLE0" name="ARTICLE[]" id="ARTICLE0" onchange="coba(this.id)" onfocusout="hitung()" required></select>
									</div>
								</td>
								...
								<td><input name="GOLONG[]" id="GOLONG0" type="text" class="form-control GOLONG" maxlength="1" readonly></td>
								<td><input name="LUSIN[]" onclick="select()" onkeyup="hitung()" value="0" id="LUSIN0" type="text" class="form-control LUSIN rightJustified text-primary"></td>
								<td><input name="PAIR[]" onclick="select()" onkeyup="hitung()" value="0" id="PAIR0" type="text" class="form-control PAIR rightJustified text-primary"></td>
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TLUSIN rightJustified text-primary font-weight-bold" id="TLUSIN" name="TLUSIN" value="0" readonly></td>
							<td><input class="form-control TPAIR rightJustified text-primary font-weight-bold" id="TPAIR" name="TPAIR" value="0" readonly></td>
							<td></td>
							<td></td>
						</tfoot>
					</table>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control TJUMLAH rightJustified text-primary font-weight-bold" onchange="hitung()" value="0" id="TJUMLAH" name="TJUMLAH" readonly>
				</div>
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control DISC rightJustified text-danger font-weight-bold" onfocusout="hitung()" onchange="hitung()" value="0" id="DISC" name="DISC">
				</div>
			</div>
		</div>
		<div class="col-md-12">
...
<script>
	...
	function select2x() {
		$('.js-example-responsive').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Penerimaan_Barang/getDataAjax_Article') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
