...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_Penerimaan_Barang/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="225px">No Beli</th>
                        <th width="210px">Tanggal Beli</th>
                        <th width="225px">No SJ</th>
                        <th width="210px">Tanggal SJ</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Penerimaan_Barang/get_ajax_beli') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
        ...
        $("div.test_btn").html('<a class="btn type="hidden" btn-md btn-primary"  href="<?php echo site_url('admin/Transaksi_Penerimaan_Barang/print') ?>"></a>');
        $('#example').show();
    });
</script>