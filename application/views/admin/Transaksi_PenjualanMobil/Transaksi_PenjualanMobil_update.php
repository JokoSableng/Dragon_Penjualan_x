<?php
foreach ($penjualanmobil as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="penjualanmobil" name="penjualanmobil" action="<?php echo base_url('admin/Transaksi_PenjualanMobil/update_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
