...
<div class="container-fluid">
	...
	<form id="penjualanmobil" name="penjualanmobil" action="<?php echo base_url('admin/Transaksi_PenjualanMobil/input_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_PenjualanMobil/filter_no_surat'); ?>',
				data: {
					no_surat: no_surat
				},
				dataType: 'json',
