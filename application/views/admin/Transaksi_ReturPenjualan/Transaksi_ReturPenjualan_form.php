...
<div class="container-fluid">
	...
	<form id="returpenjualanpms" name="returpenjualanpms" action="<?php echo base_url('admin/Transaksi_ReturPenjualan/input_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						<input class="form-control text_input NO_BUKTI" id="NO_BUKTI" name="NO_BUKTI" type="hidden" value='' readonly>
						<input type="hidden" class="date form-control text_input" id="TGL" name="TGL" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST["tampilkan"])) {
																																				echo $_POST["TGL"];
						...
						<div class="col-md-2 input-group">
							...
							<span class="input-group-btn">
								<a class="btn default" onfocusout="hitung()" id="0" data-target="#mymodal_no_jual" data-toggle="modal" href="#lupsj"><i class="fa fa-search"></i></a>
							</span>
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-2">
							<input class="form-control text_input NO_FKTR" id="NO_FKTR" name="NO_FKTR" type="text" value='' readonly>
						</div>
						<div class="col-md-1">
							<label class="label">Tgl Faktur </label>
						</div>
						<div class="col-md-2">
							<input class="form-control text_input TGL_FKTR" id="TGL_FKTR" name="TGL_FKTR" type="text" value='' readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input INVOICE" id="INVOICE" name="INVOICE" type="text" value='' readonly>
						</div>
						<div class="col-md-1">
			...
			<div class="modal-body">
				<table class='table table-bordered' id='modal_no_jual'>
					...
					<tbody>
						...
						?>
							<tr>
								<td class='NO_SURATVAL'><button class="btn btn-primary btn-sm select_no_jual w-100"><?php echo $b->NO_SURAT; ?></button></td>
								<td class='TGL_SJVAL text_input'><?php echo $b->TGL_SJ; ?></td>
								<td class='NO_FKTRVAL text_input'><?php echo $b->NO_FKTR; ?></td>
								<td class='TGL_FKTRVAL text_input'><?php echo $b->TGL_FKTR; ?></td>
								<td class='INVOICE_VAL text_input'><?php echo $b->INVOICE; ?></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_jual', function() {
			var val = $(this).parents("tr").find(".NO_SURATVAL").text();
			$("#NO_SURAT").val(val);
			var val = $(this).parents("tr").find(".TGL_SJVAL").text();
			$("#TGL_SJ").val(val);
			var val = $(this).parents("tr").find(".NO_FKTRVAL").text();
			$("#NO_FKTR").val(val);
			var val = $(this).parents("tr").find(".TGL_FKTRVAL").text();
			$("#TGL_FKTR").val(val);
			var val = $(this).parents("tr").find(".INVOICE_VAL").text();
			$("#INVOICE").val(val);
			...
			var no_jual = $(this).parents("tr").find(".NO_SURATVAL").text();
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_ReturPenjualan/filter_no_jual'); ?>',
				data: {
					no_jual: no_jual
				},
				dataType: 'json',
