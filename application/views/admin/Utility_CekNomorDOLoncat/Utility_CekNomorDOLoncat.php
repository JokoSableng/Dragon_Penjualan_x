...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            ...
            <i class="fas fa-university"></i> Cek Nomor DO Loncat/Double
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="CekNomorDOLoncat" method="post" action="<?php echo base_url('admin/Utility_CekNomorDOLoncat/index_Utility_CekNomorDOLoncat') ?>">
            <!-- Ganti 3, sesuai ganti 1 di CONTROLLER - LAPORAN -->
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Option :</label>
                    </div>
                    <div class="col-md-2">
                        <select class="form-control option" name="option" id="option" style="width: 100%;">
                            <option value="0">--------------------</option>
                            <option value="1">Nomor DO Loncat</option>
                            <option value="2">Nomor DO Double</option>
                        </select>
                    </div>
                </div>
            </div>
