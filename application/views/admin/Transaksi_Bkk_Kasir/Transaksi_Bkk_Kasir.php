...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_Bkk_Kasir/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Bkk_Kasir/get_ajax_kas') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
