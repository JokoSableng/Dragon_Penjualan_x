...
<div class="container-fluid">
	...
	<form id="suratpesananmutasi" name="suratpesananmutasi" action="<?php echo base_url('admin/Transaksi_SuratPesananMutasi/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function fill_no_do() {
		var nod0 = $("#NO_DO").val();
		$.ajax({
			url: "<?= base_url('admin/Transaksi_SuratPesananMutasi/mintanodo') ?>",
			data: {
				'nodo': nod0,
			},
	...
	function btIsiNoDo() {
		if (confirm("Yakin isi No DO ? \n Setelah No Do diisi, maka form ini hanya bisa lihat data")) {
			document.getElementById("suratpesananmutasi").submit();
			// window.location.replace("<?php echo base_url('admin/Transaksi_SuratPesananMutasi/update_aksi/' . $rowh->ID) ?>");
		}
	}
