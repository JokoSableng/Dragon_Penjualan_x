...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Surat Pesanan Mutasi
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_SuratPesananMutasi/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="250px">No Sp</th>
                        <th width="250px">Tgl Sp</th>
                        <th width="225px">No Do</th>
                        <th width="195px">Tgl Do</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_SuratPesananMutasi/get_ajax_stockb') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
