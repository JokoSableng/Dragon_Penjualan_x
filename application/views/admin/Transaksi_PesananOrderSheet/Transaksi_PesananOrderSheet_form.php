...
<div class="container-fluid">
	...
	<form id="pesananordersheet" name="pesananordersheet" action="<?php echo base_url('admin/Transaksi_PesananOrderSheet/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input NO_DO" id="NO_DO" name="NO_DO" type="text" value=''>
						</div>
						<div class="col-md-1">
							<label class="label">Tgl DO </label>
						</div>
						<div class="col-md-2">
							<input type="text" class="date form-control text_input" id="TGL_DO" name="TGL_DO" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST["tampilkan"])) {
																																						echo $_POST["TGL_DO"];
																																					} else echo date('d-m-Y'); ?>" onclick="select()">
						</div>
					</div>
							...
							<tr>
								...
								<td>
									<div class="input-group">
										<select class="js-example-responsive-kd_brg form-control KD_BRG0 text_input" name="KD_BRG[]" id="KD_BRG0" onchange="kd_brg(this.id)" onfocusout="hitung()" required></select>
									</div>
								</td>
								...
								<td>
									<div class="input-group">
										<select class="js-example-responsive-kodec form-control KODEC0 text_input" name="KODEC[]" id="KODEC0" onchange="kodec(this.id)" onfocusout="hitung()" required></select>
									</div>
								</td>
								<td><input name="NAMAC[]" id="NAMAC0" type="text" class="form-control NAMAC text_input" readonly></td>
								<td><input name="KOTA[]" id="KOTA0" type="text" class="form-control KOTA text_input" readonly></td>
								<td>
...
<script>
	...
	function tambah() {
		...
		td7.innerHTML = "<input name='HARGA[]' onclick='select()' onkeyup='hitung()' value='0' id=HARGA" + idrow + " type='text' class='form-control HARGA rightJustified text-primary'>";
		td8.innerHTML = "<input name='QTY[]' onclick='select()' onkeyup='hitung()' value='0' id=QTY" + idrow + " type='text' class='form-control QTY rightJustified text-primary'>";
		td9.innerHTML = "<input name='TOTAL[]' onclick='select()' value='0' id=TOTAL" + idrow + " type='text' class='form-control TOTAL rightJustified text-primary' readonly>";
