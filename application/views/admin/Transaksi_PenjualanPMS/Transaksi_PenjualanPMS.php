...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Transaksi Penjualan Wilayah
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Transaksi_PenjualanPMS/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        var wilayah = $('#example').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_PenjualanPMS/get_ajax_jual') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
        ...
        $("div.test_btn").html(`<select class="form-control text_input WILAYAH" name="WILAYAH" id="WILAYAH" style="width:300px;">
