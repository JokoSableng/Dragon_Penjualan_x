...
<div class="container-fluid">
	...
	<form id="penjualanpms" name="penjualanpms" action="<?php echo base_url('admin/Transaksi_PenjualanPMS/input_aksi'); ?>" class="form-horizontal" method="post">
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td><input class="form-control TOTAL_HARGA rightJustified text-primary font-weight-bold" id="TOTAL_HARGA" name="TOTAL_HARGA" value="0" readonly></td>
							<td><input class="form-control TOTAL_HARGAP rightJustified text-primary font-weight-bold" id="TOTAL_HARGAP" name="TOTAL_HARGAP" value="0" readonly></td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_no_surat', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_PenjualanPMS/filter_no_surat'); ?>',
				data: {
					no_surat: no_surat
				},
				dataType: 'json',
	...
	function hitung() {
		...
		for (i = 0; i < total_row; i++) {
			var qty = parseFloat($('#QTYP' + i).val().replace(/,/g, ''));
			var harga = parseFloat($('#HARGAP' + i).val().replace(/,/g, ''));
		...
		if (isNaN(TOTAL_HARGAP)) TOTAL_HARGAP = 0;
		...
		$('#TOTAL_HARGAP').val(numberWithCommas(TOTAL_HARGAP));
