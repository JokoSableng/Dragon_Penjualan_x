...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Rincian Penjualan Langganan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rincianpenjualanlangganan" method="post" action="<?php echo base_url('admin/laporan/index_Rincian_Penjualan_Langganan') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $rincian_penjualan_langganan,
                    "name" => "example",
                    "showFooter"=>true,
                    "showFooter"=>"bottom",
                    "columns" => array(
