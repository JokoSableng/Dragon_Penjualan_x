...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Rincian Penjualan Golongan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="penjualan_rencianpenjualangolongan" method="post" action="<?php echo base_url('admin/laporan/index_Penjualan_RincianPenjualanGolongan') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $penjualan_rincianpenjualangolongan,
                    "name" => "example",
                    "fixedHeader" => true,
                    "showFooter" => true,
                    "showFooter" => "bottom",
