...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Kas Harian
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="kas_harian" method="post" action="<?php echo base_url('admin/laporan/index_Kas_Harian') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Tanggal Bukti</label>
                    </div>
