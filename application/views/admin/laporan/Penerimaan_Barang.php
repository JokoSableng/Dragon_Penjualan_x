...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Penerimaan Barang
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="penerimaan_barang" method="post" action="<?php echo base_url('admin/laporan/index_Penerimaan_Barang') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3 nopadding">
                        <input type="text" class="date form-control text_input" id="TGLLPB_1" name="TGLLPB_1" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST["tampilkan"])) {
                                                                                                                                                        echo $_POST["TGLLPB_1"];
                    ...
                    <div class="col-md-3 nopadding">
                        <input type="text" class="date form-control text_input" id="TGLLPB_2" name="TGLLPB_2" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST["tampilkan"])) {
                                                                                                                                                        echo $_POST["TGLLPB_2"];
                                                                                                                                                    } else echo date('d-m-Y'); ?>">
                    </div>
                </div>
