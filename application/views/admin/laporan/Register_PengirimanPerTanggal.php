...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pengiriman Per Tanggal
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="register_pengirimanpertanggal" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerTanggal') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanpertanggal,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
