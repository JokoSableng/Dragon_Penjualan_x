...
<!-- Ganti 1, sesuai judul -->
            <i class="fas fa-university"></i> Laporan Kartu Piutang 
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
<!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="kartupiutang" method="post" action="<?php echo base_url('admin/laporan/index_KartuPiutang') ?>">
<!-- Ganti 3, sesuai ganti 1 di CONTROLLER - LAPORAN -->
            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3 nopadding">
                        <input type="text" class="date form-control text_input" id="TGL_TRAN_2" name="TGL_TRAN_2" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST["tampilkan"])) { echo $_POST["TGL_TRAN_2"]; } else echo date('d-m-Y'); ?>">
                    </div>
                </div>
            </div>
<!-- Batas ganti 3 -->
