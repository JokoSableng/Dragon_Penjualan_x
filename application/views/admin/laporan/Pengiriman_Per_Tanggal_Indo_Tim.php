...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pengiriman Per Tanggal Indo Tim
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pengiriman_per_tanggal_indo_tim" method="post" action="<?php echo base_url('admin/laporan/index_Pengiriman_Per_Tanggal_Indo_Tim') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Tanggal Sj</label>
                    </div>
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $pengiriman_per_tanggal_indo_tim,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "NOSJ" => array(
