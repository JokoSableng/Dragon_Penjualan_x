...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Master Customer
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="mastercustomer" method="post" action="<?php echo base_url('admin/laporan/index_Master_Customer') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1 nopadding">
                        <label class="label-title">KDMTS </label>
                    </div>
                    <div class="col-md-3 nopadding">
                        <input type="text" value="<?php echo $this->session->userdata['kdmts']; ?>" class="form-control form-control-user KDMTS" id="KDMTS" name="KDMTS" readonly>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
