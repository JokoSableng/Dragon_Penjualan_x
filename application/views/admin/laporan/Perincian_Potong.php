...
<!-- Ganti 1, sesuai judul -->
            <i class="fas fa-university"></i> Laporan Perincian Potong
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
<!-- Ganti 2, sesuai ganti 1 di CONTROLLER - LAPORAN -->
        <form id="frmrbiaya" method="post" action="<?php echo base_url('admin/laporan/index_Perincian_Potong') ?>">
