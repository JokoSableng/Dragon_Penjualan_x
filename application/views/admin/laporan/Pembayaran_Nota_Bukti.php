...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Pembayaran Nota Bukti
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pembayarannotabukti" method="post" action="<?php echo base_url('admin/laporan/index_Pembayaran_Nota_Bukti') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $pembayaran_nota_bukti,
                    "name" => "example",
                    "showFooter"=>true,
                    "showFooter"=>"bottom",
                    "columns" => array(
