...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Rekap Pembayaran Wilayah
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rekappembayaranwilayah" method="post" action="<?php echo base_url('admin/laporan/index_Pembayaran_RekapPembayaranWilayah') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $rekap_pembayaran_wilayah,
                    "name" => "example",
                    "showFooter" => true,
                    "showFooter" => "bottom",
                    "columns" => array(
