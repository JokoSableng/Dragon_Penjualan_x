...
<section>
    <div class="container-fluid">
        ...
        <form id="registerpengirimanjatimpertanggal" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerTanggalJatim') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanpertanggaljatim,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "NO_BUKTI" => array(
