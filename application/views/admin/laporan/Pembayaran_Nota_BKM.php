...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Pembayaran Nota BKM
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pembayarannotabkm" method="post" action="<?php echo base_url('admin/laporan/index_Pembayaran_Nota_BKM') ?>">
            <div class="col-md-12">
