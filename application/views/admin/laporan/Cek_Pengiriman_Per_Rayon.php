...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Cek Pengiriman Per Rayon
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="cek_pengiriman_per_rayon" method="post" action="<?php echo base_url('admin/laporan/index_Cek_Pengiriman_Per_Rayon') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Kode Rayon </label>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control KODERAY_2" name="KODERAY_2" id="KODERAY_2" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["KODERAY_2"] == $KODERAY_2) {
                                echo '<option value="' . $KODERAY_2 . '" selected >' . $KODERAY_2 . '</option>';
                            } ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $cek_pengiriman_per_rayon,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "NOSJ" => array(
...
<script>
    ...
    function select_koderay_1() {
        $('#KODERAY_1').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_koderay_rc_custom_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
            ...
            placeholder: 'Masukan Kode Rayon ...',
    ...
    function select_koderay_2() {
        $('#KODERAY_2').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_koderay_rc_custom_2') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
                data: function(params) {
