...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pengiriman Jatim Per Tanggal
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="registerpengirimanindotimpertanggal" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerTanggalIndoTim') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanpertanggalindotim,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
