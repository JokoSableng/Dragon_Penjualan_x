...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Master Article
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="masterarticle" method="post" action="<?php echo base_url('admin/laporan/index_Master_Article') ?>">
            <div class="col-md-12">
