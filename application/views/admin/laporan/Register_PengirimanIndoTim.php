...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pengiriman Indo Tim
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="registerpengirimanindotim" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanIndoTim') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanindotim,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
