...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Penerimaan Article
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rekappenerimaanarticle" method="post" action="<?php echo base_url('admin/laporan/index_Rekap_PenerimaanArticle') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $rekap_penerimaanarticle,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
