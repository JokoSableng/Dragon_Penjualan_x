...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Register Penjualan Wilayah
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="langganan_rincianpenjualanwilayah" method="post" action="<?php echo base_url('admin/laporan/index_Langganan_RincianPenjualanWilayah') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $langganan_rincianpenjualanwilayah,
                    "name" => "example",
                    "fixedHeader" => true,
                    "showFooter" => true,
                    "showFooter" => "bottom",
