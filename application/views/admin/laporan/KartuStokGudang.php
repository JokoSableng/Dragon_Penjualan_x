        ...
        <form id="surat_pesanan" method="post" action="<?php echo base_url('admin/laporan/index_Kartu_Stok_Gudang') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control KD_ARTICLE" name="KD_ARTICLE" id="KD_ARTICLE" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["KD_ARTICLE"] == $KD_ARTICLE) {
                                echo '<option value="' . $KD_ARTICLE . '" selected >' . $KD_ARTICLE . '</option>';
                            } ?>
                        </select>
                    </div>
                    <div class="col-md-1">
...
<script>
    ...
    function select_kd_article_1() {
        $('#KD_ARTICLE').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_kdarticle_articled_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
