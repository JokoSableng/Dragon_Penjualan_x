...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Sisa Nota Wilayah
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="sisanotawilayah" method="post" action="<?php echo base_url('admin/laporan/index_SisaNotaWilayah') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <label class="label">Jenis
                        </label>
                    </div>
                    <div class="col-md-2">
                        <select class="form-control text_input JENIS" name="JENIS" id="JENIS">
                            <?php if (isset($_POST["tampilkan"]) && $_POST["JENIS"] == '1') {
                                echo "<option value='1' selected>Sebelum Bayar</option>";
                                echo "<option value='2'>Sesudah Bayar</option>";
                            } else {
                                echo "<option value='1'>Sebelum Bayar</option>";
                                echo "<option value='2' selected>Sesudah Bayar</option>";
                            }
                            ?>
                        </select>
                    </div>
