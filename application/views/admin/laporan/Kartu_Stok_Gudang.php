...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Kartu Stok Gudang
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="surat_pesanan" method="post" action="<?php echo base_url('admin/laporan/index_Kartu_Stok_Gudang') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control ARTICLE_1" name="ARTICLE_1" id="ARTICLE_1" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["ARTICLE_1"] == $ARTICLE_1) {
                                echo '<option value="' . $ARTICLE_1 . '" selected >' . $ARTICLE_1 . '</option>';
                            } ?>
                        </select>
                    </div>
                    <div class="col-md-1">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control ARTICLE_2" name="ARTICLE_2" id="ARTICLE_2" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["ARTICLE_2"] == $ARTICLE_2) {
                                echo '<option value="' . $ARTICLE_2 . '" selected >' . $ARTICLE_2 . '</option>';
                            } ?>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    function select_article_1() {
        $('#ARTICLE_1').select2({
            ...
            placeholder: 'Masukan No Article ...',
