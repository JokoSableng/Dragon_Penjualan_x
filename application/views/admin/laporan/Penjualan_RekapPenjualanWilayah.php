...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Rekap Penjualan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="penjualan_rekappenjualanwilayah" method="post" action="<?php echo base_url('admin/laporan/index_Penjualan_RekapPenjualanWilayah') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $penjualan_rekappenjualanwilayah,
                    "name" => "example",
                    "fixedHeader" => true,
                    "showFooter" => true,
                    "showFooter" => "bottom",
