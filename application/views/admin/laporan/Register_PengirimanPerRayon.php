...
<section>
    <div class="container-fluid">
        ...
        <form id="register_pengirimanperrayon" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerRayon') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanperrayon,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
