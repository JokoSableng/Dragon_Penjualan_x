...
<section>
    <div class="container-fluid">
        ...
        <form id="pengirimanpercustomerarticle" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerCustomerArticle') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanpercustomerarticle,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
