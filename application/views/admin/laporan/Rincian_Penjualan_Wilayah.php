...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Rincian Penjualan Wilayah
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rincianpenjualanwilayah" method="post" action="<?php echo base_url('admin/laporan/index_Rincian_Penjualan_Wilayah') ?>">
            <div class="col-md-12">
