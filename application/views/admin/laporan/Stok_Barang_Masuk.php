...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Stok Barang Masuk
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="surat_pesanan" method="post" action="<?php echo base_url('admin/laporan/index_Stok_Barang_Masuk') ?>">
            <div class="col-md-12">
