...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pengiriman Per Tanggal Jatim
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pengiriman_per_tanggal" method="post" action="<?php echo base_url('admin/laporan/index_Pengiriman_Per_Tanggal_Jatim') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $pengiriman_per_tanggal_jatim,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "NOSJ" => array(
