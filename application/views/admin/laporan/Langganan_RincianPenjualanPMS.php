...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Rincian Penjualan PMS
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="langganan_rincianpenjualanpms" method="post" action="<?php echo base_url('admin/laporan/index_Langganan_RincianPenjualanPMS') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <label class="label">Periode
                        </label>
                    </div>
                    <div class="col-md-1">
                        <select class="form-control text_input PERKE" name="PERKE" id="PERKE">
                            <?php if (isset($_POST["tampilkan"]) && $_POST["PERKE"] == 'A') {
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $langganan_rincianpenjualanpms,
                    "name" => "example",
                    "fixedHeader" => true,
                    "showFooter" => true,
                    "showFooter" => "bottom",
