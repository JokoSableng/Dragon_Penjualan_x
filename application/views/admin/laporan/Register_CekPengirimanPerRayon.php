...
<section>
    <div class="container-fluid">
        ...
        <form id="register_cekpengirimanperrayon" method="post" action="<?php echo base_url('admin/laporan/index_Register_CekPengirimanPerRayon') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_cekpengirimanperrayon,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
...
<script>
    ...
    function select_koderay_1() {
        $('#KODERAY_1').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_koderay_rc_cihdr_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
