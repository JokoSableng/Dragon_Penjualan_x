...
<section>
    <div class="container-fluid">
        ...
        <form id="pengirimanpertoko" method="post" action="<?php echo base_url('admin/laporan/index_Register_PengirimanPerToko') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Per </label>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $register_pengirimanpertoko,
                    "name" => "example",
                    "showFooter" => "bottom",
                    "columns" => array(
                        "PER" => array(
