...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Surat Jalan Mutasi
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="rekap_suratjalanmutasi" method="post" action="<?php echo base_url('admin/laporan/index_Rekap_SuratJalanMutasi') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $rekap_suratjalanmutasi,
                    "name" => "example",
                    "showFooter"=>"bottom",
                    "columns" => array(
                        "PER" => array(
...
<script>
    ...
    function select_nosj_1() {
        $('#NOSJ_1').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_nosj_rc_cimhdr_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
    ...
    function select_nosj_2() {
        $('#NOSJ_2').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_nosj_rc_cimhdr_2') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
                data: function(params) {
