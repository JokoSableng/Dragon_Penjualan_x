...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Pembayaran Nota BBM
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pembayarannotabbm" method="post" action="<?php echo base_url('admin/laporan/index_Pembayaran_Nota_BBM') ?>">
            <div class="col-md-12">
