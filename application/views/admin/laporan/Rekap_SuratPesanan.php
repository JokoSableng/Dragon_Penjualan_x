...
<section>
    <div class="container-fluid">
        ...
        <form id="rekap_suratpesanan" method="post" action="<?php echo base_url('admin/laporan/index_Rekap_SuratPesanan') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control NO_BUKTI_2" name="NO_BUKTI_2" id="NO_BUKTI_2" style="width: 100%;">
                            <?php
...
<script>
    ...
    function select_no_bukti_po_2() {
        $('#NO_BUKTI_2').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_no_bukti_po_2') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
                data: function(params) {
