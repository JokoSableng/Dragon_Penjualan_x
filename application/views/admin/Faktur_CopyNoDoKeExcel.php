...
<section>
	<div class="container-fluid">
		...
		<form id="faktur_copynodokeexcel" method="post" action="<?php echo base_url('admin/Transaksi_CopyJualPerPeriode/index_Transaksi_CopyJualPerPeriode') ?>">
			<div class="col-md-12">
			...
			<div class="report-content">
				...
				DataTables::create(array(
					"dataStore" => $faktur_copynodokeexcel,
					"name" => "example",
					"fixedHeader" => true,
					"showFooter" => true,
					"showFooter" => "bottom",
