...
<section>
	<div class="container-fluid">
		...
		<div class="alert alert-success alert-container" role="alert">
			<i class="fas fa-university"></i> Transaksi Copy Excel PI
		</div>
		<?php echo $this->session->flashdata('pesan') ?>
		<form id="transaksi_copyexcelpi" method="post" action="<?php echo base_url('admin/Transaksi_CopyExcelPI/index_Transaksi_CopyExcelPI') ?>">
			<div class="col-md-12">
			...
			<div class="report-content">
				...
				DataTables::create(array(
					"dataStore" => $transaksi_copyexcelpi,
					"name" => "example",
					"fixedHeader" => true,
					"showFooter" => true,
					"showFooter" => "bottom",
...
<script>
	...
	function select_kodec() {
		$('#KODEC').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_CopyExcelPI/getData_cust') ?>",
				dataType: "json",
				type: "post",
				delay: 250,
