...
<div class="container-fluid">
	...
	<form id="penjualanpkp" name="penjualanpkp" action="<?php echo base_url('admin/Transaksi_PenjualanPKP/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						<div class="col-md-1">
							<label class="label">JTempo </label>
						</div>
						<div class="input-group col-md-2">
							<input type="text" class="date form-control text_input" id="JTEMPO" name="JTEMPO" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->JTEMPO, TRUE)); ?>" onclick="select()">
						</div>
						<div class="col-md-1">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1">
							<input class="form-control text_input TAX" id="TAX" name="TAX" type="text" value="<?php echo $rowh->TAX ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
			...
			<div class="modal-body">
				<table class='table table-bordered' id='modal_no_sj'>
					...
					<tbody>
						...
						?>
							<tr>
								<td class='NSSVAL'><a href="#" class="select_no_sj"><?php echo $b->NO_CET; ?></a></td>
								<td class='TSSVAL text_input'><?php echo $b->TGL; ?></td>
