<?php
foreach ($penjualanbahan as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="penjualanbahan" name="penjualanbahan" action="<?php echo base_url('admin/Transaksi_PenjualanBahan/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
