...
<section>
	<div class="container-fluid">
		...
		<div class="alert alert-success alert-container" role="alert">
			<i class="fas fa-university"></i> Faktur Penjualan Excel Harian
		</div>
		<?php echo $this->session->flashdata('pesan') ?>
		<form id="faktur_penjualanexcelharian" method="post" action="<?php echo base_url('admin/Faktur_PenjualanExcelHarian/index_Faktur_PenjualanExcelHarian') ?>">
			<div class="col-md-12">
			...
			<div class="report-content">
				...
				DataTables::create(array(
					"dataStore" => $faktur_penjualanexcelharian,
					"name" => "example",
					"fixedHeader" => true,
					"showFooter" => true,
					"showFooter" => "bottom",
