<?php
foreach ($suratpesananmutasi as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="suratpesananmutasi" name="suratpesananmutasi" action="<?php echo base_url('admin/DataPMS_SuratPesananMutasi/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1" style="justify-content: center;">
							...
							if ($rowh->DIVAL_JL == 0)
								...
								>
									<span style="color: black; font-weight: bold;"><i class="fa fa-check"></i> VALIDASI</span>
								</a>';
							?>
						</div>
					</div>
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input type="text" class="form-control text_input" id="TGL_DO" name="TGL_DO" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->TGL_DO, TRUE)); ?>" onclick="select()" readonly>
						</div>
						<div class="col-md-1">
				...
				<div class="col-md-12">
					<div class="form-group row">
						<div class="col-md-1">
							<label class="label">User Val </label>
						</div>
						<div class="col-md-3">
							<input class="form-control text_input USRNMVAL_JL" id="USRNMVAL_JL" name="USRNMVAL_JL" type="text" value="<?php echo $rowh->USRNMVAL_JL ?>" readonly>
						</div>
						<div class="col-md-1">
							<label class="label">Tgl Val </label>
						</div>
						<div class="col-md-3">
							<input <?php
									if ($rowh->TGSMPVAL_JL == '2001-01-01 00:00:01') echo 'value=""'; ?> class="form-control text_input TGSMPVAL_JL" id="TGSMPVAL_JL" name="TGSMPVAL_JL" type="text" value="<?php echo $rowh->TGSMPVAL_JL ?>" readonly>
						</div>
						<div class="col-md-1">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						<thead>
							<tr>
								<th width="50px">No</th>
								<th width="170px">Barang</th>
								<th width="130px">Warna</th>
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($suratpesananmutasi as $row) :
							?>
								<tr>
...
<script>
	...
	function fill_no_do() {
		var nod0 = $("#NO_DO").val();
		$.ajax({
			url: "<?= base_url('admin/DataPMS_SuratPesananMutasi/mintanodo') ?>",
			data: {
				'nodo': nod0,
			},
	...
	function btValidasi() {
		if (confirm("Yakin validasi data ini?")) {
			...
			window.location.replace("<?php echo base_url('admin/DataPMS_SuratPesananMutasi/verifikasi_suratpesananmutasi/' . $rowh->ID) ?>");
		} else {
			alert("Batal Posting!");
		}
	}
