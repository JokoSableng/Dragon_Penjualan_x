...
class Transaksi_KonfirmasiPesananSheetVal extends CI_Controller
{
        ...
        foreach ($list as $proforma) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_KonfirmasiPesananSheetVal/update/' . $proforma->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
    ...
    public function index_Transaksi_KonfirmasiPesananSheetVal()
    {
        $data['proforma'] = $this->master_model->tampil_data('proforma', 'NO_ID')->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_KonfirmasiPesananSheetVal/Transaksi_KonfirmasiPesananSheetVal', $data);
    ...
    public function update($NO_ID)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_KonfirmasiPesananSheetVal/Transaksi_KonfirmasiPesananSheetVal_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        redirect('admin/Transaksi_KonfirmasiPesananSheetVal/index_Transaksi_KonfirmasiPesananSheetVal');
    }
