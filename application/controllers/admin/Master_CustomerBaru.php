...
class Master_CustomerBaru extends CI_Controller
{
        ...
        foreach ($list as $cust) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Master_CustomerBaru/update/' . $cust->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Master_CustomerBaru/delete/' . $cust->NO_ID) . '"  onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
            $row[] = $cust->KODEC;
    ...
    public function index_Master_CustomerBaru()
    {
        $data['cust'] = $this->master_model->tampil_data('cust', 'NO_ID')->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Master_CustomerBaru/Master_CustomerBaru', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Master_CustomerBaru/Master_CustomerBaru_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Master_CustomerBaru/index_Master_CustomerBaru');
    }
    ...
    public function update($NO_ID)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Master_CustomerBaru/Master_CustomerBaru_update', $data);
        $this->load->view('templates_admin/footer');
    }
