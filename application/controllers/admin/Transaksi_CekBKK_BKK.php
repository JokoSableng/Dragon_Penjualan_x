...
class Transaksi_CekBKK_BKK extends CI_Controller
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where($where);
        $this->db->where("(TGL_CAIR='0000-00-00' AND TGL_CAIR='2001-01-01') OR TGL_CAIR>TGL");
        $i = 0;
        ...
        foreach ($list as $jl_piu) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_CekBKK_BKK/delete/' . $jl_piu->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $jl_piu->NO_BUKTI;
    ...
    public function index_Transaksi_CekBKK_BKK()
    {
        $where = array();
        $data['wilayah'] = $this->transaksi_model->tampil_data($where, 'wilayah', 'NO_ID')->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKK/Transaksi_CekBKK_BKK', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKK/Transaksi_CekBKK_BKK_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_CekBKK_BKK/index_Transaksi_CekBKK_BKK');
    }
    ...
    public function update($id)
    {
        ...
        $data['cekbkk_bkk'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKK/Transaksi_CekBKK_BKK_update', $data);
        $this->load->view('templates_admin/footer');
    }
