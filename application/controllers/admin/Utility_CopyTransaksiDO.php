...
class Utility_CopyTransaksiDO extends CI_Controller
{
	...
	public function index_Utility_CopyTransaksiDO()
	{
		if (isset($_POST["print"])) {
			...
			$this->load->view('admin/Utility_CopyTransaksiDO/Utility_CopyTransaksiDO', $data);
