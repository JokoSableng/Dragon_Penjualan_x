...
class Transaksi_CekBKK_BKMBG extends CI_Controller
{
        ...
        foreach ($list as $jl_piu) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_CekBKK_BKMBG/update/' . $jl_piu->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_CekBKK_BKMBG/delete/' . $jl_piu->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $jl_piu->NO_BUKTI;
    ...
    public function index_Transaksi_CekBKK_BKMBG()
    {
        $where = array();
        $data['wilayah'] = $this->transaksi_model->tampil_data($where, 'wilayah', 'NO_ID')->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKMBG/Transaksi_CekBKK_BKMBG', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKMBG/Transaksi_CekBKK_BKMBG_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_CekBKK_BKMBG/index_Transaksi_CekBKK_BKMBG');
    }
    ...
    public function update($id)
    {
        ...
        $data['cekbkk_bkmbg'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_CekBKK_BKMBG/Transaksi_CekBKK_BKMBG_update', $data);
        $this->load->view('templates_admin/footer');
    }
