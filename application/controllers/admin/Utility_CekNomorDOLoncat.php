...
class Utility_CekNomorDOLoncat extends CI_Controller
{
	...
	public function index_Utility_CekNomorDOLoncat()
	{
		if (isset($_POST["print"])) {
			...
			$this->load->view('admin/Utility_CekNomorDOLoncat/Utility_CekNomorDOLoncat', $data);
