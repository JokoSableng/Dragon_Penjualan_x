...
class Transaksi_CopyExcelPI extends CI_Controller
{
    ...
    public function index_Transaksi_CopyExcelPI()
    {
        if (isset($_POST["print"])) {
            ...
            $data['transaksi_copyexcelpi'] = $this->laporan_model->tampil_data_transaksi_copyexcelpi()->result();
            $this->load->view('templates_admin/header');
            $this->load->view('templates_admin/navbar');
            $this->load->view('admin/Transaksi_CopyExcelPI', $data);
