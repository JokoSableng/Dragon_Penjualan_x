...
class Transaksi_ProformaInvoiceExpor extends CI_Controller
{
        ...
        foreach ($list as $proforma) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_ProformaInvoiceExpor/update/' . $proforma->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_ProformaInvoiceExpor/delete/' . $proforma->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
    ...
    public function index_Transaksi_ProformaInvoiceExpor()
    {
        $periode = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Transaksi Proforma Invoice Expor');
        $where = array(
            'PER' => $periode,
            'FLAG' => 'PI',
            'EXPORT' => '1'
        ...
        $this->load->view('admin/Transaksi_ProformaInvoiceExpor/Transaksi_ProformaInvoiceExpor', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_ProformaInvoiceExpor/Transaksi_ProformaInvoiceExpor_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_ProformaInvoiceExpor/index_Transaksi_ProformaInvoiceExpor');
    }
    ...
    public function update($id)
    {
        ...
        $data['proformainvoiceexpor'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_ProformaInvoiceExpor/Transaksi_ProformaInvoiceExpor_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_ProformaInvoiceExpor.jrxml");
        $NO_ID = $id;
