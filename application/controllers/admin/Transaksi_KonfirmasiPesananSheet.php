...
class Transaksi_KonfirmasiPesananSheet extends CI_Controller
{
        ...
        foreach ($list as $proforma) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_KonfirmasiPesananSheet/update/' . $proforma->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
    ...
    public function index_Transaksi_KonfirmasiPesananSheet()
    {
        $periode = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Transaksi Konfirmasi Pesanan Sheet');
        $where = array(
            'PER' => $periode,
            'FLAG' => 'PI',
            'EXPORT' => '1'
        ...
        $this->load->view('admin/Transaksi_KonfirmasiPesananSheet/Transaksi_KonfirmasiPesananSheet', $data);
    ...
    public function update($id)
    {
        ...
        $data['konfirmasipesanansheet'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_KonfirmasiPesananSheet/Transaksi_KonfirmasiPesananSheet_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        redirect('admin/Transaksi_KonfirmasiPesananSheet/index_Transaksi_KonfirmasiPesananSheet');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_KonfirmasiPesananSheet.jrxml");
        $NO_ID = $id;
