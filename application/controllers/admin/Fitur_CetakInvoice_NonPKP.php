...
class Fitur_CetakInvoice_NonPKP extends CI_Controller
{
        ...
        foreach ($list as $jual) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Fitur_CetakInvoice_NonPKP/update/' . $jual->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Fitur_CetakInvoice_NonPKP/delete/' . $jual->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
            $row[] = $jual->NO_BUKTI;
    ...
    public function index_Fitur_CetakInvoice_NonPKP()
    {
        $periode = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Fitur Cetak Invoice Non PKP');
        $where = array(
            'PER' => $periode,
            'FLAG' => 'JR',
            'TAX <>' => 'P'
        ...
        $this->load->view('admin/Fitur_CetakInvoice_NonPKP/Fitur_CetakInvoice_NonPKP', $data);
    ...
    public function update($id)
    {
        $q1 = "SELECT jual.NO_ID as ID,
            ...
            ORDER BY juald.REC";
        $data['cetakinvoicenonpkp'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Fitur_CetakInvoice_NonPKP/Fitur_CetakInvoice_NonPKP_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        */
        ...
        redirect('admin/Fitur_CetakInvoice_NonPKP/index_Fitur_CetakInvoice_NonPKP');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Fitur_CetakInvoice_InvoiceNonPKP.jrxml");
        $NO_ID = $id;
