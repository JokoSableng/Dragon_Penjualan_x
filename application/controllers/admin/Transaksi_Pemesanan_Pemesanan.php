...
class Transaksi_Pemesanan_Pemesanan extends CI_Controller
{
        ...
        foreach ($list as $so) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Pemesanan_Pemesanan/update/' . $so->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
    ...
    public function index_Transaksi_Pemesanan_Pemesanan()
    {
        $per = $this->session->userdata['periode'];
        ...
        $this->load->view('admin/Transaksi_Pemesanan_Pemesanan/Transaksi_Pemesanan_Pemesanan', $data);
    ...
    public function update($id)
    {
        $q1 = "SELECT so.NO_ID as ID,
            ...
            AND so.NO_ID = sod.ID 
            ORDER BY sod.REC";
        $data['pemesanan_pemesanan'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Pemesanan_Pemesanan/Transaksi_Pemesanan_Pemesanan_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        redirect('admin/Transaksi_Pemesanan_Pemesanan/index_Transaksi_Pemesanan_Pemesanan');
    }
    ...
    function JASPER($no_b)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Pemesanan_Pemesanan.jrxml");
        $no_bukti = $no_b;
