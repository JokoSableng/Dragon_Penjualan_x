...
class Fitur_CetakInvoice_InvoicePKPCustom extends CI_Controller
{
        ...
        foreach ($list as $jual) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="' . site_url('admin/Fitur_CetakInvoice_InvoicePKPCustom/update/' . $jual->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Fitur_CetakInvoice_InvoicePKPCustom/delete/' . $jual->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>';
            $row[] = $no . ".";
            $row[] = $jual->NO_BUKTI;
    ...
    public function index_Fitur_CetakInvoice_InvoicePKPCustom()
    {
        $periode = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Fitur Cetak Invoice PKP Custom');
        $where = array(
            'PER' => $periode,
            'FLAG' => 'JR',
            'TAX' => 'P'
        ...
        $this->load->view('admin/Fitur_CetakInvoice_InvoicePKPCustom/Fitur_CetakInvoice_InvoicePKPCustom', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Fitur_CetakInvoice_InvoicePKPCustom/Fitur_CetakInvoice_InvoicePKPCustom_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Fitur_CetakInvoice_InvoicePKPCustom/index_Fitur_CetakInvoice_InvoicePKPCustom');
    }
    ...
    public function update($id)
    {
        $q1 = "SELECT jual.NO_ID as ID,
            ...
            ORDER BY juald.REC";
        $data['cetakinvoicepkpcustom'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Fitur_CetakInvoice_InvoicePKPCustom/Fitur_CetakInvoice_InvoicePKPCustom_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Fitur_CetakInvoice_InvoicePKPCustom.jrxml");
        $NO_ID = $id;
